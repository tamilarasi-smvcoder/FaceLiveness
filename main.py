...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket' : "faceattendancerealtime-aba69.appspot.com"
})
...
while True:
    ...
    if faceCurFrame:
        ...
        if counter != 0:
            label = test(
                image=img,
                model_dir='C:/Users/smvta/PycharmProjects/FaceLiveness/Silent-Face-Anti-Spoofing/resources/anti_spoof_models',
                device_id=0
            )
            print(label)
            if label == 1:
